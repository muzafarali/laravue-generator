...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName)
    {
        ...
        $this->defaultSearchable = config('laravue.laravue_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('laravue.laravue_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('laravue.laravue_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('laravue.laravue_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('laravue.laravue_generator.timestamps.deleted_at', 'deleted_at');
