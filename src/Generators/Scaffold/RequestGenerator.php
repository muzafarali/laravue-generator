...
class RequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = get_template('scaffold.request.create_request', 'laravue-generator');
    ...
    {
        $templateData = get_template('scaffold.request.update_request', 'laravue-generator');
