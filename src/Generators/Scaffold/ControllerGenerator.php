...
class ControllerGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        if ($this->commandData->getAddOn('datatables')) {
            $templateData = get_template('scaffold.controller.datatable_controller', 'laravue-generator');

            $this->generateDataTable();
        } else {
            $templateData = get_template('scaffold.controller.controller', 'laravue-generator');
    ...
    {
        $templateData = get_template('scaffold.datatable', 'laravue-generator');
