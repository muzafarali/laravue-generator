...
class RoutesGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        if (!empty($this->commandData->config->prefixes['route'])) {
            $this->routesTemplate = get_template('scaffold.routes.prefix_routes', 'laravue-generator');
        } else {
            $this->routesTemplate = get_template('scaffold.routes.routes', 'laravue-generator');
        }
